...
/**
 * This is the model class for table "test_reader".
 *
 * The followings are the available columns in table 'test_reader':
 * @property integer $id
...
class Reader extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			//array('id, create_date, edit_date', 'numerical', 'integerOnly'=>false),
