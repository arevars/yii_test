...
class ReaderController extends Controller
{
	...
	public function actionCreate()
	{
		...
		{
		    //Перехватываем пост массив и конвертируем в timestamp
		    // @todo реализовать в beforeSave():
		    /*$cd = $_POST['Reader']['create_date'];
		    $ed = $_POST['Reader']['edit_date'];
		    
		    $_POST['Reader']['create_date'] = CDateTimeParser::parse($cd,'dd/MM/yyyy');
		    $_POST['Reader']['edit_date'] = CDateTimeParser::parse($ed,'dd/MM/yyyy');
		   */
